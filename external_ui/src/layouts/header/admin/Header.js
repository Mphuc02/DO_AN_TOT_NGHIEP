          ...
          Phòng khám da liễu Minh Phúc
                ...
                {thisAdmin && (
                    <div className="flex items-center">
                        <div className="text-blue-700">
                            Xin chào,{" "}
                            {(() => {
                                console.log('this', thisAdmin, 'hehe')
                                if (!thisAdmin) {
                                    return null;
                                }

                                return `${thisAdmin.fullName.firstName} ${thisAdmin.fullName.middleName} ${thisAdmin.fullName.lastName}`;
                            })()}
                        </div>
                ...
                {!thisAdmin  && (
                    <div className="flex items-center">
                        <div className="flex items-center ms-3">
                            <Link
                                to={RoutesConstant.DOCTOR.LOGIN}
